    ...
    return (
        <div className="auth-container" style={{ background: 'linear-gradient(135deg,rgb(168, 112, 167) 0%,rgb(161, 98, 135) 100%)', padding: '80px 40px', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <div className="form-card" style={{
                ...
                <div className="check-box" style={{ display: 'flex', flexWrap: 'wrap', gap: '5px', marginBottom: '10px' }}>
                    {skills.map(skill => (
                        <div key={skill}>
                            <input
                                type="checkbox"
                            ...
                            />
                            <label htmlFor={skill} style={{ marginLeft: '5px',color:'black' }}>{skill}</label>
                        </div>
                    ))}
                </div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '5px', marginBottom: '40px' }}>
                    {interests.map(interest => (
                        <div key={interest}>
                            ...
                            />
                            <label htmlFor={interest} style={{ marginLeft: '5px', color: 'black' }}>{interest}</label>
                        </div>
                    ))}
                </div>
